...
{
   SetKeyword(wxFitsKeyword::EF_ANGLE, angle);
}
...
{
   SetKeyword(wxFitsKeyword::EF_DISTANCE, distance);
}

void wxFitsKeywordEx::PowerKwd(float power)
{
   SetKeyword(wxFitsKeyword::EF_POWER, power);
}
